...
import com.ildar.attainment.adapter.CurrentTaskAdapter;
...
public class CurrentTaskFragment extends TaskFragment {
    ...
    public void addTask(ModelTask newTask, boolean saveToDB){
        ...
        if (newTask.getDate() != 0){
            ...
            System.out.println(newTask.getTitle() + " = " + calendar.get(Calendar.DATE) + " || " + Calendar.getInstance().get(Calendar.DAY_OF_YEAR));
            if (calendar.get(Calendar.DAY_OF_YEAR) < Calendar.getInstance().get(Calendar.DAY_OF_YEAR)){
                newTask.setDateStatys(ModelSeparator.TYPE_OVERDUE);
                ...
                newTask.setDateStatys(ModelSeparator.TYPE_TODAY);
                ...
                newTask.setDateStatys(ModelSeparator.TYPE_TOMORROW);
                ...
                newTask.setDateStatys(ModelSeparator.TYPE_FUTURE);
        ...
        if (position != -1){
            if (!adapter.getItem(position-1).isTask()){
                if (position - 2 >= 0 && adapter.getItem(position-2).isTask()){
                    ...
                    if (task.getDateStatys() == newTask.getDateStatys()){
                        position -= 1;
                    }
