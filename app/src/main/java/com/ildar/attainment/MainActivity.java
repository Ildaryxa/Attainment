...
import com.ildar.attainment.adapter.TabAdapter;
import com.ildar.attainment.alarm.AlarmHelper;
import com.ildar.attainment.dateBase.DBHelper;
import com.ildar.attainment.dialog.AddTaskDialogFragment;
import com.ildar.attainment.dialog.EditTaskDialogFragment;
import com.ildar.attainment.fragment.CurrentTaskFragment;
import com.ildar.attainment.fragment.DoneTaskFragment;
import com.ildar.attainment.fragment.SplashFragment;
import com.ildar.attainment.fragment.TaskFragment;
import com.ildar.attainment.model.ModelTask;

public class MainActivity extends AppCompatActivity implements  AddTaskDialogFragment.AddingTaskListener,
    ...
    private void setUI(){
        ...
        viewPager.addOnPageChangeListener(new TabLayout.TabLayoutOnPageChangeListener(tabLayout)); //слушатель на событие смены вкладок
